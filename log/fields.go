...
const logFieldsKey logCtxKeyType = "log_fields"

// A FieldType indicates which member of the Field union struct should be used
// and how it should be serialized. This allows the work of serializing the data
// to be deferred until _after_ deciding to output the log message
...
func nilField(key string) Field { return String(key, "<nil>") }
